...
const Equipment = () => {
    ...
    useEffect(() => {
        axios.get(`https://app-seomaweb.herokuapp.com/api/detailEquipment/${id}`)
            .then(response => {
                console.log(response.data.response)
                setEquipment(response.data.response.equipment)
            })
        axios.get(`https://app-seomaweb.herokuapp.com/api/questions/${id}`)
            .then(response => {
    ...
    const favorite = async (id) => {
        ...
        if (!token) {
            ...
            axios.put(`https://app-seomaweb.herokuapp.com/api/favorite/${id}`, {},
    ...
    const submitQuestions = async (event) => {
        ...
        await axios.post("https://app-seomaweb.herokuapp.com/api/questions", { dataQuestions })
            .then(response => {
